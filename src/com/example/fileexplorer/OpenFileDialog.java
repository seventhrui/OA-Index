...
public class OpenFileDialog {
	...
	public static Dialog createDialog(int type, int id, Context context,
	...
	static class FileSelectView extends ListView implements OnItemClickListener {
		...
		private int type = 0;// 文件浏览器类型 0 文件浏览器，1 文件夹浏览器
		private String suffix = null;

		private Map<String, Integer> imagemap = null;

		public FileSelectView(int type, Context context, int dialogid,
